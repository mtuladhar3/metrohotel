  ...
  return (
    <div className="offer-card group relative bg-[#121214] border border-white/10 rounded-2xl overflow-hidden hover:border-white/30 transition-all duration-500 flex flex-col justify-between shadow-xl">
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-900">
        ...
        {/* Hotel/Branch Tag */}
        <div className="absolute top-4 left-4 flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/15 text-white/90 text-[11px] font-mono tracking-wide">
      ...
      <div className="p-6 flex flex-col flex-1 justify-between">
        <div>
          <h3 className="font-serif text-xl sm:text-2xl text-white tracking-wide group-hover:text-amber-200 transition-colors">
            {offer.title}
          </h3>
        ...
        <div className="flex items-center justify-between mt-6 pt-4 border-t border-white/10">
          <div>
            <span className="text-[10px] uppercase font-mono text-white-400 block">Starting From</span>
            <span className="text-lg font-serif text-white">{offer.price}</span>
          </div>
